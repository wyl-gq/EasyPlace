...
class BlockActorType:
    ...
    Count = 61
en_to_ch = {'minecraft:acacia_boat': '金合欢木船', 'minecraft:acacia_button': '金合欢木按钮', 'minecraft:acacia_chest_boat': '金合欢木运输船', 'minecraft:acacia_door': '金合欢木门', 'minecraft:acacia_fence': '金合欢木栅栏', 'minecraft:acacia_fence_gate': '金合欢木栅栏门', 'minecraft:acacia_hanging_sign': '悬挂式金合欢木告示牌', 'minecraft:acacia_leaves': '金合欢树叶', 'minecraft:acacia_log': '金合欢原木', 'minecraft:acacia_planks': '金合欢木板', 'minecraft:acacia_pressure_plate': '金合欢木压力板', 'minecraft:acacia_sapling': '金合欢树苗', 'minecraft:acacia_sign': '金合欢木告示牌', 'minecraft:acacia_slab': '金合欢木台阶', 'minecraft:acacia_stairs': '金合欢木楼梯', 'minecraft:acacia_trapdoor': '金合欢木活板门', 'minecraft:acacia_wood': '金合欢木', 'minecraft:activator_rail': '激活铁轨', 'minecraft:allay_spawn_egg': '悦灵刷怪蛋', 'minecraft:allium': '绒球葱', 'minecraft:allow': '允许方块', 'minecraft:amethyst_block': '紫水晶块', 'minecraft:amethyst_cluster': '紫水晶簇', 'minecraft:amethyst_shard': '紫水晶碎片', 'minecraft:ancient_debris': '远古残骸', 'minecraft:andesite': '安山岩', 'minecraft:andesite_stairs': '安山岩楼梯', 'minecraft:andesite_wall': '安山岩墙', 'minecraft:angler_pottery_sherd': '垂钓纹样陶片', 'minecraft:anvil': '铁砧', 'minecraft:apple': '苹果', 'minecraft:archer_pottery_sherd': '弓箭纹样陶片', 'minecraft:armadillo_scute': '犰狳鳞甲', 'minecraft:armadillo_spawn_egg': '犰狳刷怪蛋', 'minecraft:armor_stand': '盔甲架', 'minecraft:arrow': '箭', 'minecraft:axolotl_bucket': '美西螈桶', 'minecraft:axolotl_spawn_egg': '美西螈刷怪蛋', 'minecraft:azalea': '杜鹃花丛', 'minecraft:azalea_leaves': '杜鹃树叶', 'minecraft:azure_bluet': '蓝花美耳草', 'minecraft:baked_potato': '烤马铃薯', 'minecraft:bamboo': '竹子', 'minecraft:bamboo_block': '竹块', 'minecraft:bamboo_button': '竹按钮', 'minecraft:bamboo_chest_raft': '运输竹筏', 'minecraft:bamboo_door': '竹门', 'minecraft:bamboo_fence': '竹栅栏', 'minecraft:bamboo_fence_gate': '竹栅栏门', 'minecraft:bamboo_hanging_sign': '悬挂式竹告示牌', 'minecraft:bamboo_mosaic': '竹马赛克', 'minecraft:bamboo_mosaic_slab': '竹马赛克台阶', 'minecraft:bamboo_mosaic_stairs': '竹马赛克楼梯', 'minecraft:bamboo_planks': '竹板', 'minecraft:bamboo_pressure_plate': '竹压力板', 'minecraft:bamboo_raft': '竹筏', 'minecraft:bamboo_sign': '竹告示牌', 'minecraft:bamboo_slab': '竹台阶', 'minecraft:bamboo_stairs': '竹楼梯', 'minecraft:bamboo_trapdoor': '竹活板门', 'minecraft:barrel': '木桶', 'minecraft:barrier': '屏障', 'minecraft:basalt': '玄武岩', 'minecraft:bat_spawn_egg': '蝙蝠刷怪蛋', 'minecraft:beacon': '信标', 'minecraft:bedrock': '基岩', 'minecraft:bee_nest': '蜂巢', 'minecraft:bee_spawn_egg': '蜜蜂刷怪蛋', 'minecraft:beef': '生牛肉', 'minecraft:beehive': '蜂箱', 'minecraft:beetroot': '甜菜根', 'minecraft:beetroot_seeds': '甜菜种子', 'minecraft:beetroot_soup': '甜菜汤', 'minecraft:bell': '钟', 'minecraft:big_dripleaf': '大型垂滴叶', 'minecraft:birch_boat': '白桦木船', 'minecraft:birch_button': '白桦木按钮', 'minecraft:birch_chest_boat': '白桦木运输船', 'minecraft:birch_door': '白桦木门', 'minecraft:birch_fence': '白桦木栅栏', 'minecraft:birch_fence_gate': '白桦木栅栏门', 'minecraft:birch_hanging_sign': '悬挂式白桦木告示牌', 'minecraft:birch_leaves': '白桦树叶', 'minecraft:birch_log': '白桦原木', 'minecraft:birch_planks': '白桦木板', 'minecraft:birch_pressure_plate': '白桦木压力板', 'minecraft:birch_sapling': '白桦树苗', 'minecraft:birch_sign': '白桦木告示牌', 'minecraft:birch_slab': '白桦木台阶', 'minecraft:birch_stairs': '白桦木楼梯', 'minecraft:birch_trapdoor': '白桦木活板门', 'minecraft:birch_wood': '白桦木', 'minecraft:black_banner': '黑色旗帜', 'minecraft:black_bed': '黑色床', 'minecraft:black_candle': '黑色蜡烛', 'minecraft:black_carpet': '黑色地毯', 'minecraft:black_concrete': '黑色混凝土', 'minecraft:black_concrete_powder': '黑色混凝土粉末', 'minecraft:black_dye': '黑色染料', 'minecraft:black_glazed_terracotta': '黑色带釉陶瓦', 'minecraft:black_shulker_box': '黑色潜影盒', 'minecraft:black_stained_glass': '黑色染色玻璃', 'minecraft:black_stained_glass_pane': '黑色染色玻璃板', 'minecraft:black_terracotta': '黑色陶瓦', 'minecraft:black_wool': '黑色羊毛', 'minecraft:blackstone': '黑石', 'minecraft:blackstone_slab': '黑石台阶', 'minecraft:blackstone_stairs': '黑石楼梯', 'minecraft:blackstone_wall': '黑石墙', 'minecraft:blade_pottery_sherd': '利刃纹样陶片', 'minecraft:blast_furnace': '高炉', 'minecraft:blaze_powder': '烈焰粉', 'minecraft:blaze_rod': '烈焰棒', 'minecraft:blaze_spawn_egg': '烈焰人刷怪蛋', 'minecraft:blue_banner': '蓝色旗帜', 'minecraft:blue_bed': '蓝色床', 'minecraft:blue_candle': '蓝色蜡烛', 'minecraft:blue_carpet': '蓝色地毯', 'minecraft:blue_concrete': '蓝色混凝土', 'minecraft:blue_concrete_powder': '蓝色混凝土粉末', 'minecraft:blue_dye': '蓝色染料', 'minecraft:blue_glazed_terracotta': '蓝色带釉陶瓦', 'minecraft:blue_ice': '蓝冰', 'minecraft:blue_orchid': '兰花', 'minecraft:blue_shulker_box': '蓝色潜影盒', 'minecraft:blue_stained_glass': '蓝色染色玻璃', 'minecraft:blue_stained_glass_pane': '蓝色染色玻璃板', 'minecraft:blue_terracotta': '蓝色陶瓦', 'minecraft:blue_wool': '蓝色羊毛', 'minecraft:bone': '骨头', 'minecraft:bone_block': '骨块', 'minecraft:bone_meal': '骨粉', 'minecraft:book': '书', 'minecraft:bookshelf': '书架', 'minecraft:bow': '弓', 'minecraft:bowl': '碗', 'minecraft:brain_coral': '脑纹珊瑚', 'minecraft:brain_coral_block': '脑纹珊瑚块', 'minecraft:brain_coral_fan': '脑纹珊瑚扇', 'minecraft:bread': '面包', 'minecraft:brewer_pottery_sherd': '佳酿纹样陶片', 'minecraft:brewing_stand': '酿造台', 'minecraft:brick': '红砖', 'minecraft:brick_slab': '红砖台阶', 'minecraft:brick_stairs': '红砖楼梯', 'minecraft:brick_wall': '红砖墙', 'minecraft:bricks': '红砖块', 'minecraft:brown_banner': '棕色旗帜', 'minecraft:brown_bed': '棕色床', 'minecraft:brown_candle': '棕色蜡烛', 'minecraft:brown_carpet': '棕色地毯', 'minecraft:brown_concrete': '棕色混凝土', 'minecraft:brown_concrete_powder': '棕色混凝土粉末', 'minecraft:brown_dye': '棕色染料', 'minecraft:brown_glazed_terracotta': '棕色带釉陶瓦', 'minecraft:brown_mushroom': '棕色蘑菇', 'minecraft:brown_mushroom_block': '棕色蘑菇方块', 'minecraft:brown_shulker_box': '棕色潜影盒', 'minecraft:brown_stained_glass': '棕色染色玻璃', 'minecraft:brown_stained_glass_pane': '棕色染色玻璃板', 'minecraft:brown_terracotta': '棕色陶瓦', 'minecraft:brown_wool': '棕色羊毛', 'minecraft:brush': '刷子', 'minecraft:bubble_coral': '气泡珊瑚', 'minecraft:bubble_coral_block': '气泡珊瑚块', 'minecraft:bubble_coral_fan': '气泡珊瑚扇', 'minecraft:bucket': '桶', 'minecraft:budding_amethyst': '紫水晶母岩', 'minecraft:bundle': '收纳袋', 'minecraft:burn_pottery_sherd': '烈焰纹样陶片', 'minecraft:cactus': '仙人掌', 'minecraft:cake': '蛋糕', 'minecraft:calcite': '方解石', 'minecraft:calibrated_sculk_sensor': '校准型幽匿感测体', 'minecraft:camel_spawn_egg': '骆驼刷怪蛋', 'minecraft:campfire': '营火', 'minecraft:candle': '蜡烛', 'minecraft:carrot': '胡萝卜', 'minecraft:carrot_on_a_stick': '胡萝卜钓竿', 'minecraft:cartography_table': '制图台', 'minecraft:carved_pumpkin': '雕刻南瓜', 'minecraft:cat_spawn_egg': '猫刷怪蛋', 'minecraft:cauldron': '炼药锅', 'minecraft:cave_spider_spawn_egg': '洞穴蜘蛛刷怪蛋', 'minecraft:chain': '锁链', 'minecraft:chain_command_block': '连锁型命令方块', 'minecraft:chainmail_boots': '锁链靴子', 'minecraft:chainmail_chestplate': '锁链胸甲', 'minecraft:chainmail_helmet': '锁链头盔', 'minecraft:chainmail_leggings': '锁链护腿', 'minecraft:charcoal': '木炭', 'minecraft:cherry_boat': '樱花木船', 'minecraft:cherry_button': '樱花木按钮', 'minecraft:cherry_chest_boat': '樱花木运输船', 'minecraft:cherry_door': '樱花木门', 'minecraft:cherry_fence': '樱花木栅栏', 'minecraft:cherry_fence_gate': '樱花木栅栏门', 'minecraft:cherry_hanging_sign': '悬挂式樱花木告示牌', 'minecraft:cherry_leaves': '樱花树叶', 'minecraft:cherry_log': '樱花原木', 'minecraft:cherry_planks': '樱花木板', 'minecraft:cherry_pressure_plate': '樱花木压力板', 'minecraft:cherry_sapling': '樱花树苗', 'minecraft:cherry_sign': '樱花木告示牌', 'minecraft:cherry_slab': '樱花木台阶', 'minecraft:cherry_stairs': '樱花木楼梯', 'minecraft:cherry_trapdoor': '樱花木活板门', 'minecraft:cherry_wood': '樱花木', 'minecraft:chest': '箱子', 'minecraft:chest_minecart': '运输矿车', 'minecraft:chicken': '生鸡肉', 'minecraft:chicken_spawn_egg': '鸡刷怪蛋', 'minecraft:chipped_anvil': '轻微损坏的铁砧', 'minecraft:chorus_flower': '紫颂花', 'minecraft:chorus_fruit': '紫颂果', 'minecraft:chorus_plant': '紫颂植株', 'minecraft:clay': '黏土', 'minecraft:clay_ball': '黏土球', 'minecraft:clock': '时钟', 'minecraft:coal': '煤炭', 'minecraft:coal_block': '煤炭块', 'minecraft:coal_ore': '煤矿石', 'minecraft:coarse_dirt': '砂土', 'minecraft:coast_armor_trim_smithing_template': '海岸盔甲纹饰锻造模板', 'minecraft:cobbled_deepslate': '深板岩圆石', 'minecraft:cobbled_deepslate_slab': '深板岩圆石台阶', 'minecraft:cobbled_deepslate_stairs': '深板岩圆石楼梯', 'minecraft:cobbled_deepslate_wall': '深板岩圆石墙', 'minecraft:cobblestone': '圆石', 'minecraft:cobblestone_slab': '圆石台阶', 'minecraft:cobblestone_stairs': '圆石楼梯', 'minecraft:cobblestone_wall': '圆石墙', 'minecraft:cobweb': '蜘蛛网', 'minecraft:cocoa_beans': '可可豆', 'minecraft:cod': '鳕鱼', 'minecraft:cod_bucket': '鳕鱼桶', 'minecraft:cod_spawn_egg': '鳕鱼刷怪蛋', 'minecraft:command_block': '命令方块', 'minecraft:command_block_minecart': '命令方块矿车', 'minecraft:comparator': '红石比较器', 'minecraft:compass': '指南针', 'minecraft:composter': '堆肥桶', 'minecraft:conduit': '潮涌核心', 'minecraft:cooked_beef': '牛排', 'minecraft:cooked_chicken': '熟鸡肉', 'minecraft:cooked_cod': '熟鳕鱼', 'minecraft:cooked_mutton': '熟羊肉', 'minecraft:cooked_porkchop': '熟猪排', 'minecraft:cooked_rabbit': '熟兔肉', 'minecraft:cooked_salmon': '熟鲑鱼', 'minecraft:cookie': '曲奇', 'minecraft:copper_block': '铜块', 'minecraft:copper_ingot': '铜锭', 'minecraft:copper_ore': '铜矿石', 'minecraft:cornflower': '矢车菊', 'minecraft:cow_spawn_egg': '牛刷怪蛋', 'minecraft:cracked_deepslate_bricks': '裂纹深板岩砖', 'minecraft:cracked_deepslate_tiles': '裂纹深板岩瓦', 'minecraft:cracked_nether_bricks': '裂纹下界砖', 'minecraft:cracked_polished_blackstone_bricks': '裂纹磨制黑石砖', 'minecraft:cracked_stone_bricks': '裂纹石砖', 'minecraft:crafting_table': '工作台', 'minecraft:creeper_banner_pattern': '旗帜图案（苦力怕盾徽）', 'minecraft:creeper_head': '苦力怕的头', 'minecraft:creeper_spawn_egg': '苦力怕刷怪蛋', 'minecraft:crimson_button': '绯红木按钮', 'minecraft:crimson_door': '绯红木门', 'minecraft:crimson_fence': '绯红木栅栏', 'minecraft:crimson_fence_gate': '绯红木栅栏门', 'minecraft:crimson_fungus': '绯红菌', 'minecraft:crimson_hanging_sign': '悬挂式绯红木告示牌', 'minecraft:crimson_hyphae': '绯红菌核', 'minecraft:crimson_nylium': '绯红菌岩', 'minecraft:crimson_planks': '绯红木板', 'minecraft:crimson_pressure_plate': '绯红木压力板', 'minecraft:crimson_roots': '绯红菌索', 'minecraft:crimson_sign': '绯红木告示牌', 'minecraft:crimson_slab': '绯红木台阶', 'minecraft:crimson_stairs': '绯红木楼梯', 'minecraft:crimson_stem': '绯红菌柄', 'minecraft:crimson_trapdoor': '绯红木活板门', 'minecraft:crossbow': '弩', 'minecraft:crying_obsidian': '哭泣的黑曜石', 'minecraft:cut_copper': '切制铜块', 'minecraft:cut_copper_slab': '切制铜台阶', 'minecraft:cut_copper_stairs': '切制铜楼梯', 'minecraft:cut_red_sandstone': '切制红砂岩', 'minecraft:cut_red_sandstone_slab': '切制红砂岩台阶', 'minecraft:cut_sandstone': '切制砂岩', 'minecraft:cut_sandstone_slab': '切制砂岩台阶', 'minecraft:cyan_banner': '青色旗帜', 'minecraft:cyan_bed': '青色床', 'minecraft:cyan_candle': '青色蜡烛', 'minecraft:cyan_carpet': '青色地毯', 'minecraft:cyan_concrete': '青色混凝土', 'minecraft:cyan_concrete_powder': '青色混凝土粉末', 'minecraft:cyan_dye': '青色染料', 'minecraft:cyan_glazed_terracotta': '青色带釉陶瓦', 'minecraft:cyan_shulker_box': '青色潜影盒', 'minecraft:cyan_stained_glass': '青色染色玻璃', 'minecraft:cyan_stained_glass_pane': '青色染色玻璃板', 'minecraft:cyan_terracotta': '青色陶瓦', 'minecraft:cyan_wool': '青色羊毛', 'minecraft:damaged_anvil': '严重损坏的铁砧', 'minecraft:dandelion': '蒲公英', 'minecraft:danger_pottery_sherd': '危机纹样陶片', 'minecraft:dark_oak_boat': '深色橡木船', 'minecraft:dark_oak_button': '深色橡木按钮', 'minecraft:dark_oak_chest_boat': '深色橡木运输船', 'minecraft:dark_oak_door': '深色橡木门', 'minecraft:dark_oak_fence': '深色橡木栅栏', 'minecraft:dark_oak_fence_gate': '深色橡木栅栏门', 'minecraft:dark_oak_hanging_sign': '悬挂式深色橡木告示牌', 'minecraft:dark_oak_leaves': '深色橡树叶', 'minecraft:dark_oak_log': '深色橡木原木', 'minecraft:dark_oak_planks': '深色橡木木板', 'minecraft:dark_oak_pressure_plate': '深色橡木压力板', 'minecraft:dark_oak_sapling': '深色橡树树苗', 'minecraft:dark_oak_sign': '深色橡木告示牌', 'minecraft:dark_oak_slab': '深色橡木台阶', 'minecraft:dark_oak_stairs': '深色橡木楼梯', 'minecraft:dark_oak_trapdoor': '深色橡木活板门', 'minecraft:dark_oak_wood': '深色橡木', 'minecraft:dark_prismarine': '暗海晶石', 'minecraft:dark_prismarine_slab': '暗海晶石台阶', 'minecraft:dark_prismarine_stairs': '暗海晶石楼梯', 'minecraft:daylight_detector': '阳光探测器', 'minecraft:dead_brain_coral': '失活的脑纹珊瑚', 'minecraft:dead_brain_coral_block': '失活的脑纹珊瑚块', 'minecraft:dead_brain_coral_fan': '失活的脑纹珊瑚扇', 'minecraft:dead_bubble_coral': '失活的气泡珊瑚', 'minecraft:dead_bubble_coral_block': '失活的气泡珊瑚块', 'minecraft:dead_bubble_coral_fan': '失活的气泡珊瑚扇', 'minecraft:dead_bush': '枯死的灌木', 'minecraft:dead_fire_coral': '失活的火珊瑚', 'minecraft:dead_fire_coral_block': '失活的火珊瑚块', 'minecraft:dead_fire_coral_fan': '失活的火珊瑚扇', 'minecraft:dead_horn_coral': '失活的鹿角珊瑚', 'minecraft:dead_horn_coral_block': '失活的鹿角珊瑚块', 'minecraft:dead_horn_coral_fan': '失活的鹿角珊瑚扇', 'minecraft:dead_tube_coral': '失活的管珊瑚', 'minecraft:dead_tube_coral_block': '失活的管珊瑚块', 'minecraft:dead_tube_coral_fan': '失活的管珊瑚扇', 'minecraft:debug_stick': '调试棒', 'minecraft:decorated_pot': '饰纹陶罐', 'minecraft:deepslate': '深板岩', 'minecraft:deepslate_brick_slab': '深板岩砖台阶', 'minecraft:deepslate_brick_stairs': '深板岩砖楼梯', 'minecraft:deepslate_brick_wall': '深板岩砖墙', 'minecraft:deepslate_bricks': '深板岩砖', 'minecraft:deepslate_coal_ore': '深层煤矿石', 'minecraft:deepslate_copper_ore': '深层铜矿石', 'minecraft:deepslate_diamond_ore': '深层钻石矿石', 'minecraft:deepslate_emerald_ore': '深层绿宝石矿石', 'minecraft:deepslate_gold_ore': '深层金矿石', 'minecraft:deepslate_iron_ore': '深层铁矿石', 'minecraft:deepslate_lapis_ore': '深层青金石矿石', 'minecraft:deepslate_redstone_ore': '深层红石矿石', 'minecraft:deepslate_tile_slab': '深板岩瓦台阶', 'minecraft:deepslate_tile_stairs': '深板岩瓦楼梯', 'minecraft:deepslate_tile_wall': '深板岩瓦墙', 'minecraft:deepslate_tiles': '深板岩瓦', 'minecraft:deny': '拒绝方块', 'minecraft:detector_rail': '探测铁轨', 'minecraft:diamond': '钻石', 'minecraft:diamond_axe': '钻石斧', 'minecraft:diamond_block': '钻石块', 'minecraft:diamond_boots': '钻石靴子', 'minecraft:diamond_chestplate': '钻石胸甲', 'minecraft:diamond_helmet': '钻石头盔', 'minecraft:diamond_hoe': '钻石锄', 'minecraft:diamond_horse_armor': '钻石马铠', 'minecraft:diamond_leggings': '钻石护腿', 'minecraft:diamond_ore': '钻石矿石', 'minecraft:diamond_pickaxe': '钻石镐', 'minecraft:diamond_shovel': '钻石锹', 'minecraft:diamond_sword': '钻石剑', 'minecraft:diorite': '闪长岩', 'minecraft:diorite_stairs': '闪长岩楼梯', 'minecraft:diorite_wall': '闪长岩墙', 'minecraft:dirt': '泥土', 'minecraft:dirt_path': '土径', 'minecraft:disc_fragment_5': '唱片残片', 'minecraft:dispenser': '发射器', 'minecraft:dolphin_spawn_egg': '海豚刷怪蛋', 'minecraft:donkey_spawn_egg': '驴刷怪蛋', 'minecraft:dragon_breath': '龙息', 'minecraft:dragon_egg': '龙蛋', 'minecraft:dragon_head': '龙头', 'minecraft:dried_kelp': '干海带', 'minecraft:dried_kelp_block': '干海带块', 'minecraft:dripstone_block': '滴水石块', 'minecraft:dropper': '投掷器', 'minecraft:drowned_spawn_egg': '溺尸刷怪蛋', 'minecraft:dune_armor_trim_smithing_template': '沙丘盔甲纹饰锻造模板', 'minecraft:echo_shard': '回响碎片', 'minecraft:egg': '鸡蛋', 'minecraft:elder_guardian_spawn_egg': '远古守卫者刷怪蛋', 'minecraft:elytra': '鞘翅', 'minecraft:emerald': '绿宝石', 'minecraft:emerald_block': '绿宝石块', 'minecraft:emerald_ore': '绿宝石矿石', 'minecraft:enchanted_book': '附魔书', 'minecraft:enchanted_golden_apple': '附魔金苹果', 'minecraft:enchanting_table': '附魔台', 'minecraft:end_crystal': '末影水晶', 'minecraft:end_portal_frame': '末地传送门框架', 'minecraft:end_rod': '末地烛', 'minecraft:end_stone': '末地石', 'minecraft:end_stone_brick_slab': '末地石砖台阶', 'minecraft:end_stone_brick_stairs': '末地石砖楼梯', 'minecraft:end_stone_brick_wall': '末地石砖墙', 'minecraft:end_stone_bricks': '末地石砖', 'minecraft:ender_chest': '末影箱', 'minecraft:ender_dragon_spawn_egg': '末影龙刷怪蛋', 'minecraft:ender_eye': '末影之眼', 'minecraft:ender_pearl': '末影珍珠', 'minecraft:enderman_spawn_egg': '末影人刷怪蛋', 'minecraft:endermite_spawn_egg': '末影螨刷怪蛋', 'minecraft:evoker_spawn_egg': '唤魔者刷怪蛋', 'minecraft:experience_bottle': '附魔之瓶', 'minecraft:explorer_pottery_sherd': '探险纹样陶片', 'minecraft:exposed_copper': '斑驳的铜块', 'minecraft:exposed_cut_copper': '斑驳的切制铜块', 'minecraft:exposed_cut_copper_slab': '斑驳的切制铜台阶', 'minecraft:exposed_cut_copper_stairs': '斑驳的切制铜楼梯', 'minecraft:eye_armor_trim_smithing_template': '尖啸盔甲纹饰锻造模板', 'minecraft:farmland': '耕地', 'minecraft:feather': '羽毛', 'minecraft:fermented_spider_eye': '发酵蛛眼', 'minecraft:fern': '蕨', 'minecraft:filled_map': '地图', 'minecraft:fire_charge': '火焰弹', 'minecraft:fire_coral': '火珊瑚', 'minecraft:fire_coral_block': '火珊瑚块', 'minecraft:fire_coral_fan': '火珊瑚扇', 'minecraft:firework_rocket': '烟花火箭', 'minecraft:firework_star': '烟火之星', 'minecraft:fishing_rod': '钓鱼竿', 'minecraft:fletching_table': '制箭台', 'minecraft:flint': '燧石', 'minecraft:flint_and_steel': '打火石', 'minecraft:flower_banner_pattern': '旗帜图案（花朵盾徽）', 'minecraft:flower_pot': '花盆', 'minecraft:flowering_azalea': '开花的杜鹃花丛', 'minecraft:flow_pottery_sherd': '涡流纹样陶片', 'minecraft:fox_spawn_egg': '狐狸刷怪蛋', 'minecraft:friend_pottery_sherd': '挚友纹样陶片', 'minecraft:frog_spawn_egg': '青蛙刷怪蛋', 'minecraft:frogspawn': '蛙卵', 'minecraft:furnace': '熔炉', 'minecraft:furnace_minecart': '动力矿车', 'minecraft:ghast_spawn_egg': '恶魂刷怪蛋', 'minecraft:ghast_tear': '恶魂之泪', 'minecraft:gilded_blackstone': '镶金黑石', 'minecraft:glass': '玻璃', 'minecraft:glass_bottle': '玻璃瓶', 'minecraft:glass_pane': '玻璃板', 'minecraft:glistering_melon_slice': '闪烁的西瓜片', 'minecraft:globe_banner_pattern': '旗帜图案（地球）', 'minecraft:glow_berries': '发光浆果', 'minecraft:glow_ink_sac': '发光墨囊', 'minecraft:glow_item_frame': '发光物品展示框', 'minecraft:glow_lichen': '发光地衣', 'minecraft:glow_squid_spawn_egg': '发光鱿鱼刷怪蛋', 'minecraft:glowstone': '荧石', 'minecraft:glowstone_dust': '荧石粉', 'minecraft:goat_horn': '山羊角', 'minecraft:goat_spawn_egg': '山羊刷怪蛋', 'minecraft:gold_block': '金块', 'minecraft:gold_ingot': '金锭', 'minecraft:gold_nugget': '金粒', 'minecraft:gold_ore': '金矿石', 'minecraft:golden_apple': '金苹果', 'minecraft:golden_axe': '金斧', 'minecraft:golden_boots': '金靴子', 'minecraft:golden_carrot': '金胡萝卜', 'minecraft:golden_chestplate': '金胸甲', 'minecraft:golden_helmet': '金头盔', 'minecraft:golden_hoe': '金锄', 'minecraft:golden_horse_armor': '金马铠', 'minecraft:golden_leggings': '金护腿', 'minecraft:golden_pickaxe': '金镐', 'minecraft:golden_shovel': '金锹', 'minecraft:golden_sword': '金剑', 'minecraft:granite': '花岗岩', 'minecraft:granite_stairs': '花岗岩楼梯', 'minecraft:granite_wall': '花岗岩墙', 'minecraft:grass': '草', 'minecraft:grass_block': '草方块', 'minecraft:gravel': '沙砾', 'minecraft:gray_banner': '灰色旗帜', 'minecraft:gray_bed': '灰色床', 'minecraft:gray_candle': '灰色蜡烛', 'minecraft:gray_carpet': '灰色地毯', 'minecraft:gray_concrete': '灰色混凝土', 'minecraft:gray_concrete_powder': '灰色混凝土粉末', 'minecraft:gray_dye': '灰色染料', 'minecraft:gray_glazed_terracotta': '灰色带釉陶瓦', 'minecraft:gray_shulker_box': '灰色潜影盒', 'minecraft:gray_stained_glass': '灰色染色玻璃', 'minecraft:gray_stained_glass_pane': '灰色染色玻璃板', 'minecraft:gray_terracotta': '灰色陶瓦', 'minecraft:gray_wool': '灰色羊毛', 'minecraft:green_banner': '绿色旗帜', 'minecraft:green_bed': '绿色床', 'minecraft:green_candle': '绿色蜡烛', 'minecraft:green_carpet': '绿色地毯', 'minecraft:green_concrete': '绿色混凝土', 'minecraft:green_concrete_powder': '绿色混凝土粉末', 'minecraft:green_dye': '绿色染料', 'minecraft:green_glazed_terracotta': '绿色带釉陶瓦', 'minecraft:green_shulker_box': '绿色潜影盒', 'minecraft:green_stained_glass': '绿色染色玻璃', 'minecraft:green_stained_glass_pane': '绿色染色玻璃板', 'minecraft:green_terracotta': '绿色陶瓦', 'minecraft:green_wool': '绿色羊毛', 'minecraft:grindstone': '砂轮', 'minecraft:guardian_spawn_egg': '守卫者刷怪蛋', 'minecraft:gunpowder': '火药', 'minecraft:gust_pottery_sherd': '微风纹样陶片', 'minecraft:guster_pottery_sherd': '狂风纹样陶片', 'minecraft:hanging_roots': '悬挂的根', 'minecraft:hay_block': '干草块', 'minecraft:heart_of_the_sea': '海洋之心', 'minecraft:heart_pottery_sherd': '心纹样陶片', 'minecraft:heartbreak_pottery_sherd': '心碎纹样陶片', 'minecraft:heavy_weighted_pressure_plate': '重质测重压力板', 'minecraft:hoglin_spawn_egg': '疣猪兽刷怪蛋', 'minecraft:honey_block': '蜂蜜块', 'minecraft:honey_bottle': '蜂蜜瓶', 'minecraft:honeycomb': '蜜脾', 'minecraft:honeycomb_block': '蜜脾块', 'minecraft:hopper': '漏斗', 'minecraft:hopper_minecart': '漏斗矿车', 'minecraft:horn_coral': '鹿角珊瑚', 'minecraft:horn_coral_block': '鹿角珊瑚块', 'minecraft:horn_coral_fan': '鹿角珊瑚扇', 'minecraft:horse_spawn_egg': '马刷怪蛋', 'minecraft:host_armor_trim_smithing_template': '幽匿盔甲纹饰锻造模板', 'minecraft:howl_pottery_sherd': '嗥叫纹样陶片', 'minecraft:husk_spawn_egg': '尸壳刷怪蛋', 'minecraft:ice': '冰', 'minecraft:infested_chiseled_stone_bricks': '虫蚀雕纹石砖', 'minecraft:infested_cobblestone': '虫蚀圆石', 'minecraft:infested_cracked_stone_bricks': '虫蚀裂纹石砖', 'minecraft:infested_deepslate': '虫蚀深板岩', 'minecraft:infested_mossy_stone_bricks': '虫蚀苔石砖', 'minecraft:infested_stone': '虫蚀石头', 'minecraft:infested_stone_bricks': '虫蚀石砖', 'minecraft:ink_sac': '墨囊', 'minecraft:iron_axe': '铁斧', 'minecraft:iron_bars': '铁栏杆', 'minecraft:iron_block': '铁块', 'minecraft:iron_boots': '铁靴子', 'minecraft:iron_chestplate': '铁胸甲', 'minecraft:iron_door': '铁门', 'minecraft:iron_golem_spawn_egg': '铁傀儡刷怪蛋', 'minecraft:iron_helmet': '铁头盔', 'minecraft:iron_hoe': '铁锄', 'minecraft:iron_horse_armor': '铁马铠', 'minecraft:iron_ingot': '铁锭', 'minecraft:iron_leggings': '铁护腿', 'minecraft:iron_nugget': '铁粒', 'minecraft:iron_ore': '铁矿石', 'minecraft:iron_pickaxe': '铁镐', 'minecraft:iron_shovel': '铁锹', 'minecraft:iron_sword': '铁剑', 'minecraft:iron_trapdoor': '铁活板门', 'minecraft:item_frame': '物品展示框', 'minecraft:jack_o_lantern': '南瓜灯', 'minecraft:jigsaw': '拼图方块', 'minecraft:jukebox': '唱片机', 'minecraft:jungle_boat': '丛林木船', 'minecraft:jungle_button': '丛林木按钮', 'minecraft:jungle_chest_boat': '丛林木运输船', 'minecraft:jungle_door': '丛林木门', 'minecraft:jungle_fence': '丛林木栅栏', 'minecraft:jungle_fence_gate': '丛林木栅栏门', 'minecraft:jungle_hanging_sign': '悬挂式丛林木告示牌', 'minecraft:jungle_leaves': '丛林树叶', 'minecraft:jungle_log': '丛林原木', 'minecraft:jungle_planks': '丛林木板', 'minecraft:jungle_pressure_plate': '丛林木压力板', 'minecraft:jungle_sapling': '丛林树苗', 'minecraft:jungle_sign': '丛林木告示牌', 'minecraft:jungle_slab': '丛林木台阶', 'minecraft:jungle_stairs': '丛林木楼梯', 'minecraft:jungle_trapdoor': '丛林木活板门', 'minecraft:jungle_wood': '丛林木', 'minecraft:kelp': '海带', 'minecraft:knowledge_book': '知识之书', 'minecraft:ladder': '梯子', 'minecraft:lantern': '灯笼', 'minecraft:lapis_block': '青金石块', 'minecraft:lapis_lazuli': '青金石', 'minecraft:lapis_ore': '青金石矿石', 'minecraft:large_amethyst_bud': '大型紫晶芽', 'minecraft:large_fern': '大型蕨', 'minecraft:lava_bucket': '熔岩桶', 'minecraft:lead': '拴绳', 'minecraft:leather': '皮革', 'minecraft:leather_boots': '皮革靴子', 'minecraft:leather_chestplate': '皮革外套', 'minecraft:leather_helmet': '皮革帽子', 'minecraft:leather_horse_armor': '皮革马铠', 'minecraft:leather_leggings': '皮革裤子', 'minecraft:lectern': '讲台', 'minecraft:lever': '拉杆', 'minecraft:light': '光源方块', 'minecraft:light_blue_banner': '淡蓝色旗帜', 'minecraft:light_blue_bed': '淡蓝色床', 'minecraft:light_blue_candle': '淡蓝色蜡烛', 'minecraft:light_blue_carpet': '淡蓝色地毯', 'minecraft:light_blue_concrete': '淡蓝色混凝土', 'minecraft:light_blue_concrete_powder': '淡蓝色混凝土粉末', 'minecraft:light_blue_dye': '淡蓝色染料', 'minecraft:light_blue_glazed_terracotta': '淡蓝色带釉陶瓦', 'minecraft:light_blue_shulker_box': '淡蓝色潜影盒', 'minecraft:light_blue_stained_glass': '淡蓝色染色玻璃', 'minecraft:light_blue_stained_glass_pane': '淡蓝色染色玻璃板', 'minecraft:light_blue_terracotta': '淡蓝色陶瓦', 'minecraft:light_blue_wool': '淡蓝色羊毛', 'minecraft:light_gray_banner': '淡灰色旗帜', 'minecraft:light_gray_bed': '淡灰色床', 'minecraft:light_gray_candle': '淡灰色蜡烛', 'minecraft:light_gray_carpet': '淡灰色地毯', 'minecraft:light_gray_concrete': '淡灰色混凝土', 'minecraft:light_gray_concrete_powder': '淡灰色混凝土粉末', 'minecraft:light_gray_dye': '淡灰色染料', 'minecraft:light_gray_glazed_terracotta': '淡灰色带釉陶瓦', 'minecraft:light_gray_shulker_box': '淡灰色潜影盒', 'minecraft:light_gray_stained_glass': '淡灰色染色玻璃', 'minecraft:light_gray_stained_glass_pane': '淡灰色染色玻璃板', 'minecraft:light_gray_terracotta': '淡灰色陶瓦', 'minecraft:light_gray_wool': '淡灰色羊毛', 'minecraft:light_weighted_pressure_plate': '轻质测重压力板', 'minecraft:lightning_rod': '避雷针', 'minecraft:lilac': '丁香', 'minecraft:lily_of_the_valley': '铃兰', 'minecraft:lily_pad': '睡莲', 'minecraft:lime_banner': '黄绿色旗帜', 'minecraft:lime_bed': '黄绿色床', 'minecraft:lime_candle': '黄绿色蜡烛', 'minecraft:lime_carpet': '黄绿色地毯', 'minecraft:lime_concrete': '黄绿色混凝土', 'minecraft:lime_concrete_powder': '黄绿色混凝土粉末', 'minecraft:lime_dye': '黄绿色染料', 'minecraft:lime_glazed_terracotta': '黄绿色带釉陶瓦', 'minecraft:lime_shulker_box': '黄绿色潜影盒', 'minecraft:lime_stained_glass': '黄绿色染色玻璃', 'minecraft:lime_stained_glass_pane': '黄绿色染色玻璃板', 'minecraft:lime_terracotta': '黄绿色陶瓦', 'minecraft:lime_wool': '黄绿色羊毛', 'minecraft:lingering_potion': '滞留药水', 'minecraft:lit_pumpkin': '南瓜灯', 'minecraft:llama_spawn_egg': '羊驼刷怪蛋', 'minecraft:lodestone': '磁石', 'minecraft:loom': '织布机', 'minecraft:magenta_banner': '品红色旗帜', 'minecraft:magenta_bed': '品红色床', 'minecraft:magenta_candle': '品红色蜡烛', 'minecraft:magenta_carpet': '品红色地毯', 'minecraft:magenta_concrete': '品红色混凝土', 'minecraft:magenta_concrete_powder': '品红色混凝土粉末', 'minecraft:magenta_dye': '品红色染料', 'minecraft:magenta_glazed_terracotta': '品红色带釉陶瓦', 'minecraft:magenta_shulker_box': '品红色潜影盒', 'minecraft:magenta_stained_glass': '品红色染色玻璃', 'minecraft:magenta_stained_glass_pane': '品红色染色玻璃板', 'minecraft:magenta_terracotta': '品红色陶瓦', 'minecraft:magenta_wool': '品红色羊毛', 'minecraft:magma_block': '岩浆块', 'minecraft:magma_cream': '岩浆膏', 'minecraft:magma_cube_spawn_egg': '岩浆怪刷怪蛋', 'minecraft:mangrove_boat': '红树木船', 'minecraft:mangrove_button': '红树木按钮', 'minecraft:mangrove_chest_boat': '红树木运输船', 'minecraft:mangrove_door': '红树木门', 'minecraft:mangrove_fence': '红树木栅栏', 'minecraft:mangrove_fence_gate': '红树木栅栏门', 'minecraft:mangrove_hanging_sign': '悬挂式红树木告示牌', 'minecraft:mangrove_leaves': '红树树叶', 'minecraft:mangrove_log': '红树原木', 'minecraft:mangrove_planks': '红树木板', 'minecraft:mangrove_pressure_plate': '红树木压力板', 'minecraft:mangrove_propagule': '红树胎生苗', 'minecraft:mangrove_roots': '红树根', 'minecraft:mangrove_sign': '红树木告示牌', 'minecraft:mangrove_slab': '红树木台阶', 'minecraft:mangrove_stairs': '红树木楼梯', 'minecraft:mangrove_trapdoor': '红树木活板门', 'minecraft:mangrove_wood': '红树木', 'minecraft:medium_amethyst_bud': '中型紫晶芽', 'minecraft:melon': '西瓜', 'minecraft:melon_seeds': '西瓜种子', 'minecraft:melon_slice': '西瓜片', 'minecraft:milk_bucket': '奶桶', 'minecraft:minecart': '矿车', 'minecraft:miner_pottery_sherd': '矿工纹样陶片', 'minecraft:mojang_banner_pattern': '旗帜图案（Mojang徽标）', 'minecraft:mooshroom_spawn_egg': '哞菇刷怪蛋', 'minecraft:moss_block': '苔藓块', 'minecraft:moss_carpet': '苔藓地毯', 'minecraft:mossy_cobblestone': '苔石', 'minecraft:mossy_cobblestone_slab': '苔石台阶', 'minecraft:mossy_cobblestone_stairs': '苔石楼梯', 'minecraft:mossy_cobblestone_wall': '苔石墙', 'minecraft:mossy_stone_brick_slab': '苔石砖台阶', 'minecraft:mossy_stone_brick_stairs': '苔石砖楼梯', 'minecraft:mossy_stone_brick_wall': '苔石砖墙', 'minecraft:mossy_stone_bricks': '苔石砖', 'minecraft:mourner_pottery_sherd': '悲恸纹样陶片', 'minecraft:mud': '泥巴', 'minecraft:mud_brick_slab': '泥砖台阶', 'minecraft:mud_brick_stairs': '泥砖楼梯', 'minecraft:mud_brick_wall': '泥砖墙', 'minecraft:mud_bricks': '泥砖', 'minecraft:muddy_mangrove_roots': '沾泥的红树根', 'minecraft:mule_spawn_egg': '骡刷怪蛋', 'minecraft:mushroom_stem': '蘑菇柄', 'minecraft:mushroom_stew': '蘑菇煲', 'minecraft:music_disc_11': '音乐唱片（11）', 'minecraft:music_disc_13': '音乐唱片（13）', 'minecraft:music_disc_5': '音乐唱片（5）', 'minecraft:music_disc_blocks': '音乐唱片（Blocks）', 'minecraft:music_disc_cat': '音乐唱片（Cat）', 'minecraft:music_disc_chirp': '音乐唱片（Chirp）', 'minecraft:music_disc_far': '音乐唱片（Far）', 'minecraft:music_disc_mall': '音乐唱片（Mall）', 'minecraft:music_disc_mellohi': '音乐唱片（Mellohi）', 'minecraft:music_disc_otherside': '音乐唱片（otherside）', 'minecraft:music_disc_pigstep': '音乐唱片（Pigstep）', 'minecraft:music_disc_relic': '音乐唱片（Relic）', 'minecraft:music_disc_stal': '音乐唱片（Stal）', 'minecraft:music_disc_strad': '音乐唱片（Strad）', 'minecraft:music_disc_wait': '音乐唱片（Wait）', 'minecraft:music_disc_ward': '音乐唱片（Ward）', 'minecraft:mutton': '生羊肉', 'minecraft:mycelium': '菌丝', 'minecraft:name_tag': '命名牌', 'minecraft:nautilus_shell': '鹦鹉螺壳', 'minecraft:nether_brick': '下界砖', 'minecraft:nether_brick_fence': '下界砖栅栏', 'minecraft:nether_brick_slab': '下界砖台阶', 'minecraft:nether_brick_stairs': '下界砖楼梯', 'minecraft:nether_brick_wall': '下界砖墙', 'minecraft:nether_bricks': '下界砖块', 'minecraft:nether_gold_ore': '下界金矿石', 'minecraft:nether_quartz_ore': '下界石英矿石', 'minecraft:nether_sprouts': '下界苗', 'minecraft:nether_star': '下界之星', 'minecraft:nether_wart': '下界疣', 'minecraft:nether_wart_block': '下界疣块', 'minecraft:netherite_axe': '下界合金斧', 'minecraft:netherite_block': '下界合金块', 'minecraft:netherite_boots': '下界合金靴子', 'minecraft:netherite_chestplate': '下界合金胸甲', 'minecraft:netherite_helmet': '下界合金头盔', 'minecraft:netherite_hoe': '下界合金锄', 'minecraft:netherite_ingot': '下界合金锭', 'minecraft:netherite_leggings': '下界合金护腿', 'minecraft:netherite_pickaxe': '下界合金镐', 'minecraft:netherite_scrap': '下界合金碎片', 'minecraft:netherite_shovel': '下界合金锹', 'minecraft:netherite_sword': '下界合金剑', 'minecraft:netherite_upgrade_smithing_template': '下界合金升级锻造模板', 'minecraft:netherrack': '下界岩', 'minecraft:note_block': '音符盒', 'minecraft:oak_boat': '橡木船', 'minecraft:oak_button': '橡木按钮', 'minecraft:oak_chest_boat': '橡木运输船', 'minecraft:oak_door': '橡木门', 'minecraft:oak_fence': '橡木栅栏', 'minecraft:oak_fence_gate': '橡木栅栏门', 'minecraft:oak_hanging_sign': '悬挂式橡木告示牌', 'minecraft:oak_leaves': '橡树树叶', 'minecraft:oak_log': '橡木原木', 'minecraft:oak_planks': '橡木木板', 'minecraft:oak_pressure_plate': '橡木压力板', 'minecraft:oak_sapling': '橡树树苗', 'minecraft:oak_sign': '橡木告示牌', 'minecraft:oak_slab': '橡木台阶', 'minecraft:oak_stairs': '橡木楼梯', 'minecraft:oak_trapdoor': '橡木活板门', 'minecraft:oak_wood': '橡木', 'minecraft:observer': '侦测器', 'minecraft:obsidian': '黑曜石', 'minecraft:ocelot_spawn_egg': '豹猫刷怪蛋', 'minecraft:ochre_froglight': '赭黄蛙明灯', 'minecraft:ominous_bottle': '不祥之瓶', 'minecraft:orange_banner': '橙色旗帜', 'minecraft:orange_bed': '橙色床', 'minecraft:orange_candle': '橙色蜡烛', 'minecraft:orange_carpet': '橙色地毯', 'minecraft:orange_concrete': '橙色混凝土', 'minecraft:orange_concrete_powder': '橙色混凝土粉末', 'minecraft:orange_dye': '橙色染料', 'minecraft:orange_glazed_terracotta': '橙色带釉陶瓦', 'minecraft:orange_shulker_box': '橙色潜影盒', 'minecraft:orange_stained_glass': '橙色染色玻璃', 'minecraft:orange_stained_glass_pane': '橙色染色玻璃板', 'minecraft:orange_terracotta': '橙色陶瓦', 'minecraft:orange_wool': '橙色羊毛', 'minecraft:oxeye_daisy': '滨菊', 'minecraft:oxidized_copper': '氧化的铜块', 'minecraft:oxidized_cut_copper': '氧化的切制铜块', 'minecraft:oxidized_cut_copper_slab': '氧化的切制铜台阶', 'minecraft:oxidized_cut_copper_stairs': '氧化的切制铜楼梯', 'minecraft:packed_ice': '浮冰', 'minecraft:packed_mud': '夯实泥土', 'minecraft:painting': '画', 'minecraft:panda_spawn_egg': '熊猫刷怪蛋', 'minecraft:paper': '纸', 'minecraft:parrot_spawn_egg': '鹦鹉刷怪蛋', 'minecraft:pearlescent_froglight': '珠光蛙明灯', 'minecraft:peony': '牡丹', 'minecraft:petrified_oak_slab': '石化橡木台阶', 'minecraft:phantom_membrane': '幻翼膜', 'minecraft:phantom_spawn_egg': '幻翼刷怪蛋', 'minecraft:pig_spawn_egg': '猪刷怪蛋', 'minecraft:piglin_banner_pattern': '旗帜图案（猪鼻）', 'minecraft:piglin_brute_spawn_egg': '猪灵蛮兵刷怪蛋', 'minecraft:piglin_spawn_egg': '猪灵刷怪蛋', 'minecraft:pillager_spawn_egg': '掠夺者刷怪蛋', 'minecraft:pink_banner': '粉红色旗帜', 'minecraft:pink_bed': '粉红色床', 'minecraft:pink_candle': '粉红色蜡烛', 'minecraft:pink_carpet': '粉红色地毯', 'minecraft:pink_concrete': '粉红色混凝土', 'minecraft:pink_concrete_powder': '粉红色混凝土粉末', 'minecraft:pink_dye': '粉红色染料', 'minecraft:pink_glazed_terracotta': '粉红色带釉陶瓦', 'minecraft:pink_petals': '粉红色花瓣', 'minecraft:pink_shulker_box': '粉红色潜影盒', 'minecraft:pink_stained_glass': '粉红色染色玻璃', 'minecraft:pink_stained_glass_pane': '粉红色染色玻璃板', 'minecraft:pink_terracotta': '粉红色陶瓦', 'minecraft:pink_wool': '粉红色羊毛', 'minecraft:piston': '活塞', 'minecraft:pitcher_plant': '瓶子草', 'minecraft:pitcher_pod': '瓶子草荚果', 'minecraft:player_head': '玩家头颅', 'minecraft:plenty_pottery_sherd': '富饶纹样陶片', 'minecraft:podzol': '灰化土', 'minecraft:pointed_dripstone': '滴水石锥', 'minecraft:poisonous_potato': '毒马铃薯', 'minecraft:polar_bear_spawn_egg': '北极熊刷怪蛋', 'minecraft:polished_andesite': '磨制安山岩', 'minecraft:polished_andesite_slab': '磨制安山岩台阶', 'minecraft:polished_andesite_stairs': '磨制安山岩楼梯', 'minecraft:polished_basalt': '磨制玄武岩', 'minecraft:polished_blackstone': '磨制黑石', 'minecraft:polished_blackstone_brick_slab': '磨制黑石砖台阶', 'minecraft:polished_blackstone_brick_stairs': '磨制黑石砖楼梯', 'minecraft:polished_blackstone_brick_wall': '磨制黑石砖墙', 'minecraft:polished_blackstone_bricks': '磨制黑石砖', 'minecraft:polished_blackstone_button': '磨制黑石按钮', 'minecraft:polished_blackstone_pressure_plate': '磨制黑石压力板', 'minecraft:polished_blackstone_slab': '磨制黑石台阶', 'minecraft:polished_blackstone_stairs': '磨制黑石楼梯', 'minecraft:polished_blackstone_wall': '磨制黑石墙', 'minecraft:polished_deepslate': '磨制深板岩', 'minecraft:polished_deepslate_slab': '磨制深板岩台阶', 'minecraft:polished_deepslate_stairs': '磨制深板岩楼梯', 'minecraft:polished_deepslate_wall': '磨制深板岩墙', 'minecraft:polished_diorite': '磨制闪长岩', 'minecraft:polished_diorite_slab': '磨制闪长岩台阶', 'minecraft:polished_diorite_stairs': '磨制闪长岩楼梯', 'minecraft:polished_granite': '磨制花岗岩', 'minecraft:polished_granite_slab': '磨制花岗岩台阶', 'minecraft:polished_granite_stairs': '磨制花岗岩楼梯', 'minecraft:popped_chorus_fruit': '爆裂紫颂果', 'minecraft:poppy': '虞美人', 'minecraft:porkchop': '生猪排', 'minecraft:potato': '马铃薯', 'minecraft:potion': '药水', 'minecraft:powder_snow_bucket': '细雪桶', 'minecraft:powered_rail': '动力铁轨', 'minecraft:prismarine': '海晶石', 'minecraft:prismarine_brick_slab': '海晶石砖台阶', 'minecraft:prismarine_brick_stairs': '海晶石砖楼梯', 'minecraft:prismarine_bricks': '海晶石砖', 'minecraft:prismarine_crystals': '海晶砂砾', 'minecraft:prismarine_shard': '海晶碎片', 'minecraft:prismarine_slab': '海晶石台阶', 'minecraft:prismarine_stairs': '海晶石楼梯', 'minecraft:prismarine_wall': '海晶石墙', 'minecraft:prize_pottery_sherd': '珍宝纹样陶片', 'minecraft:pufferfish': '河豚', 'minecraft:pufferfish_bucket': '河豚桶', 'minecraft:pufferfish_spawn_egg': '河豚刷怪蛋', 'minecraft:pumpkin': '南瓜', 'minecraft:pumpkin_pie': '南瓜派', 'minecraft:pumpkin_seeds': '南瓜种子', 'minecraft:purple_banner': '紫色旗帜', 'minecraft:purple_bed': '紫色床', 'minecraft:purple_candle': '紫色蜡烛', 'minecraft:purple_carpet': '紫色地毯', 'minecraft:purple_concrete': '紫色混凝土', 'minecraft:purple_concrete_powder': '紫色混凝土粉末', 'minecraft:purple_dye': '紫色染料', 'minecraft:purple_glazed_terracotta': '紫色带釉陶瓦', 'minecraft:purple_shulker_box': '紫色潜影盒', 'minecraft:purple_stained_glass': '紫色染色玻璃', 'minecraft:purple_stained_glass_pane': '紫色染色玻璃板', 'minecraft:purple_terracotta': '紫色陶瓦', 'minecraft:purple_wool': '紫色羊毛', 'minecraft:purpur_block': '紫珀块', 'minecraft:purpur_pillar': '紫珀柱', 'minecraft:purpur_slab': '紫珀台阶', 'minecraft:purpur_stairs': '紫珀楼梯', 'minecraft:quartz': '下界石英', 'minecraft:quartz_block': '石英块', 'minecraft:quartz_bricks': '石英砖', 'minecraft:quartz_pillar': '石英柱', 'minecraft:quartz_slab': '石英台阶', 'minecraft:quartz_stairs': '石英楼梯', 'minecraft:rabbit': '生兔肉', 'minecraft:rabbit_foot': '兔子脚', 'minecraft:rabbit_hide': '兔子皮', 'minecraft:rabbit_spawn_egg': '兔子刷怪蛋', 'minecraft:rabbit_stew': '兔肉煲', 'minecraft:rail': '铁轨', 'minecraft:raiser_armor_trim_smithing_template': '潮涌盔甲纹饰锻造模板', 'minecraft:ravager_spawn_egg': '劫掠兽刷怪蛋', 'minecraft:raw_copper': '粗铜', 'minecraft:raw_copper_block': '粗铜块', 'minecraft:raw_gold': '粗金', 'minecraft:raw_gold_block': '粗金块', 'minecraft:raw_iron': '粗铁', 'minecraft:raw_iron_block': '粗铁块', 'minecraft:recovery_compass': '追溯指针', 'minecraft:red_banner': '红色旗帜', 'minecraft:red_bed': '红色床', 'minecraft:red_candle': '红色蜡烛', 'minecraft:red_carpet': '红色地毯', 'minecraft:red_concrete': '红色混凝土', 'minecraft:red_concrete_powder': '红色混凝土粉末', 'minecraft:red_dye': '红色染料', 'minecraft:red_glazed_terracotta': '红色带釉陶瓦', 'minecraft:red_mushroom': '红色蘑菇', 'minecraft:red_mushroom_block': '红色蘑菇方块', 'minecraft:red_nether_brick_slab': '红色下界砖台阶', 'minecraft:red_nether_brick_stairs': '红色下界砖楼梯', 'minecraft:red_nether_brick_wall': '红色下界砖墙', 'minecraft:red_nether_bricks': '红色下界砖块', 'minecraft:red_sand': '红沙', 'minecraft:red_sandstone': '红砂岩', 'minecraft:red_sandstone_slab': '红砂岩台阶', 'minecraft:red_sandstone_stairs': '红砂岩楼梯', 'minecraft:red_sandstone_wall': '红砂岩墙', 'minecraft:red_shulker_box': '红色潜影盒', 'minecraft:red_stained_glass': '红色染色玻璃', 'minecraft:red_stained_glass_pane': '红色染色玻璃板', 'minecraft:red_terracotta': '红色陶瓦', 'minecraft:red_tulip': '红色郁金香', 'minecraft:red_wool': '红色羊毛', 'minecraft:redstone': '红石粉', 'minecraft:redstone_block': '红石块', 'minecraft:redstone_lamp': '红石灯', 'minecraft:redstone_ore': '红石矿石', 'minecraft:redstone_torch': '红石火把', 'minecraft:reinforced_deepslate': '强化深板岩', 'minecraft:repeater': '红石中继器', 'minecraft:repeating_command_block': '循环型命令方块', 'minecraft:respawn_anchor': '重生锚', 'minecraft:rib_armor_trim_smithing_template': '肋骨盔甲纹饰锻造模板', 'minecraft:rooted_dirt': '缠根泥土', 'minecraft:rose_bush': '玫瑰丛', 'minecraft:rotten_flesh': '腐肉', 'minecraft:saddle': '鞍', 'minecraft:salmon': '鲑鱼', 'minecraft:salmon_bucket': '鲑鱼桶', 'minecraft:salmon_spawn_egg': '鲑鱼刷怪蛋', 'minecraft:sand': '沙子', 'minecraft:sandstone': '砂岩', 'minecraft:sandstone_slab': '砂岩台阶', 'minecraft:sandstone_stairs': '砂岩楼梯', 'minecraft:sandstone_wall': '砂岩墙', 'minecraft:scaffolding': '脚手架', 'minecraft:scrape_pottery_sherd': '刮削纹样陶片', 'minecraft:sculk': '幽匿块', 'minecraft:sculk_catalyst': '幽匿催发体', 'minecraft:sculk_sensor': '幽匿感测体', 'minecraft:sculk_shrieker': '幽匿尖啸体', 'minecraft:sculk_vein': '幽匿脉络', 'minecraft:scute': '鳞甲', 'minecraft:sea_lantern': '海晶灯', 'minecraft:sea_pickle': '海泡菜', 'minecraft:seagrass': '海草', 'minecraft:sentinel_armor_trim_smithing_template': '哨兵盔甲纹饰锻造模板', 'minecraft:shaper_armor_trim_smithing_template': '塑形盔甲纹饰锻造模板', 'minecraft:sheaf_pottery_sherd': '麦捆纹样陶片', 'minecraft:shears': '剪刀', 'minecraft:sheep_spawn_egg': '羊刷怪蛋', 'minecraft:shelter_pottery_sherd': '庇护纹样陶片', 'minecraft:shield': '盾牌', 'minecraft:shroomlight': '菌光体', 'minecraft:undyed_shulker_box': '潜影盒', 'minecraft:shulker_shell': '潜影壳', 'minecraft:shulker_spawn_egg': '潜影贝刷怪蛋', 'minecraft:silence_armor_trim_smithing_template': '寂静盔甲纹饰锻造模板', 'minecraft:silverfish_spawn_egg': '蠹虫刷怪蛋', 'minecraft:skeleton_horse_spawn_egg': '骷髅马刷怪蛋', 'minecraft:skeleton_skull': '骷髅头颅', 'minecraft:skeleton_spawn_egg': '骷髅刷怪蛋', 'minecraft:skull_banner_pattern': '旗帜图案（头颅盾徽）', 'minecraft:skull_pottery_sherd': '头颅纹样陶片', 'minecraft:slime_ball': '黏液球', 'minecraft:slime_block': '黏液块', 'minecraft:slime_spawn_egg': '史莱姆刷怪蛋', 'minecraft:small_amethyst_bud': '小型紫晶芽', 'minecraft:small_dripleaf': '小型垂滴叶', 'minecraft:smithing_table': '锻造台', 'minecraft:smoker': '烟熏炉', 'minecraft:smooth_basalt': '平滑玄武岩', 'minecraft:smooth_quartz': '平滑石英块', 'minecraft:smooth_quartz_slab': '平滑石英台阶', 'minecraft:smooth_quartz_stairs': '平滑石英楼梯', 'minecraft:smooth_red_sandstone': '平滑红砂岩', 'minecraft:smooth_red_sandstone_slab': '平滑红砂岩台阶', 'minecraft:smooth_red_sandstone_stairs': '平滑红砂岩楼梯', 'minecraft:smooth_sandstone': '平滑砂岩', 'minecraft:smooth_sandstone_slab': '平滑砂岩台阶', 'minecraft:smooth_sandstone_stairs': '平滑砂岩楼梯', 'minecraft:smooth_stone': '平滑石头', 'minecraft:smooth_stone_slab': '平滑石头台阶', 'minecraft:snow': '雪', 'minecraft:snow_block': '雪块', 'minecraft:snow_golem_spawn_egg': '雪傀儡刷怪蛋', 'minecraft:snowball': '雪球', 'minecraft:soul_campfire': '灵魂营火', 'minecraft:soul_lantern': '灵魂灯笼', 'minecraft:soul_sand': '灵魂沙', 'minecraft:soul_soil': '灵魂土', 'minecraft:soul_torch': '灵魂火把', 'minecraft:spawner': '刷怪笼', 'minecraft:spectral_arrow': '光灵箭', 'minecraft:spider_eye': '蜘蛛眼', 'minecraft:spider_spawn_egg': '蜘蛛刷怪蛋', 'minecraft:spire_armor_trim_smithing_template': '尖塔盔甲纹饰锻造模板', 'minecraft:splash_potion': '喷溅药水', 'minecraft:sponge': '海绵', 'minecraft:spore_blossom': '孢子花', 'minecraft:spruce_boat': '云杉木船', 'minecraft:spruce_button': '云杉木按钮', 'minecraft:spruce_chest_boat': '云杉木运输船', 'minecraft:spruce_door': '云杉木门', 'minecraft:spruce_fence': '云杉木栅栏', 'minecraft:spruce_fence_gate': '云杉木栅栏门', 'minecraft:spruce_hanging_sign': '悬挂式云杉木告示牌', 'minecraft:spruce_leaves': '云杉树叶', 'minecraft:spruce_log': '云杉原木', 'minecraft:spruce_planks': '云杉木板', 'minecraft:spruce_pressure_plate': '云杉木压力板', 'minecraft:spruce_sapling': '云杉树苗', 'minecraft:spruce_sign': '云杉木告示牌', 'minecraft:spruce_slab': '云杉木台阶', 'minecraft:spruce_stairs': '云杉木楼梯', 'minecraft:spruce_trapdoor': '云杉木活板门', 'minecraft:spruce_wood': '云杉木', 'minecraft:spyglass': '望远镜', 'minecraft:squid_spawn_egg': '鱿鱼刷怪蛋', 'minecraft:stick': '木棍', 'minecraft:sticky_piston': '黏性活塞', 'minecraft:stone': '石头', 'minecraft:stone_axe': '石斧', 'minecraft:stone_brick_slab': '石砖台阶', 'minecraft:stone_brick_stairs': '石砖楼梯', 'minecraft:stone_brick_wall': '石砖墙', 'minecraft:stone_bricks': '石砖', 'minecraft:stone_button': '石按钮', 'minecraft:stone_hoe': '石锄', 'minecraft:stone_pickaxe': '石镐', 'minecraft:stone_pressure_plate': '石质压力板', 'minecraft:stone_shovel': '石锹', 'minecraft:stone_sword': '石剑', 'minecraft:stray_spawn_egg': '流浪者刷怪蛋', 'minecraft:strider_spawn_egg': '炽足兽刷怪蛋', 'minecraft:string': '线', 'minecraft:stripped_acacia_log': '去皮金合欢原木', 'minecraft:stripped_acacia_wood': '去皮金合欢木', 'minecraft:stripped_bamboo_block': '去皮竹块', 'minecraft:stripped_birch_log': '去皮白桦原木', 'minecraft:stripped_birch_wood': '去皮白桦木', 'minecraft:stripped_cherry_log': '去皮樱花原木', 'minecraft:stripped_cherry_wood': '去皮樱花木', 'minecraft:stripped_crimson_hyphae': '去皮绯红菌核', 'minecraft:stripped_crimson_stem': '去皮绯红菌柄', 'minecraft:stripped_dark_oak_log': '去皮深色橡木原木', 'minecraft:stripped_dark_oak_wood': '去皮深色橡木', 'minecraft:stripped_jungle_log': '去皮丛林原木', 'minecraft:stripped_jungle_wood': '去皮丛林木', 'minecraft:stripped_mangrove_log': '去皮红树原木', 'minecraft:stripped_mangrove_wood': '去皮红树木', 'minecraft:stripped_oak_log': '去皮橡木原木', 'minecraft:stripped_oak_wood': '去皮橡木', 'minecraft:stripped_spruce_log': '去皮云杉原木', 'minecraft:stripped_spruce_wood': '去皮云杉木', 'minecraft:stripped_warped_hyphae': '去皮诡异菌核', 'minecraft:stripped_warped_stem': '去皮诡异菌柄', 'minecraft:structure_block': '结构方块', 'minecraft:structure_void': '结构空位', 'minecraft:sugar': '糖', 'minecraft:sugar_cane': '甘蔗', 'minecraft:sunflower': '向日葵', 'minecraft:suspicious_gravel': '可疑的沙砾', 'minecraft:suspicious_sand': '可疑的沙子', 'minecraft:suspicious_stew': '迷之炖菜', 'minecraft:sweet_berries': '甜浆果', 'minecraft:tadpole_bucket': '蝌蚪桶', 'minecraft:tadpole_spawn_egg': '蝌蚪刷怪蛋', 'minecraft:tall_grass': '高草丛', 'minecraft:target': '标靶', 'minecraft:terracotta': '陶瓦', 'minecraft:tide_armor_trim_smithing_template': '海潮盔甲纹饰锻造模板', 'minecraft:tinted_glass': '遮光玻璃', 'minecraft:tnt': 'TNT', 'minecraft:tnt_minecart': 'TNT矿车', 'minecraft:torch': '火把', 'minecraft:torchflower': '火把花', 'minecraft:torchflower_seeds': '火把花种子', 'minecraft:totem_of_undying': '不死图腾', 'minecraft:trader_llama_spawn_egg': '行商羊驼刷怪蛋', 'minecraft:trapped_chest': '陷阱箱', 'minecraft:trident': '三叉戟', 'minecraft:tripwire_hook': '绊线钩', 'minecraft:tropical_fish': '热带鱼', 'minecraft:tropical_fish_bucket': '热带鱼桶', 'minecraft:tropical_fish_spawn_egg': '热带鱼刷怪蛋', 'minecraft:tube_coral': '管珊瑚', 'minecraft:tube_coral_block': '管珊瑚块', 'minecraft:tube_coral_fan': '管珊瑚扇', 'minecraft:tuff': '凝灰岩', 'minecraft:turtle_egg': '海龟蛋', 'minecraft:turtle_helmet': '海龟壳', 'minecraft:turtle_spawn_egg': '海龟刷怪蛋', 'minecraft:twisting_vines': '缠怨藤', 'minecraft:verdant_froglight': '青翠蛙明灯', 'minecraft:vex_spawn_egg': '恼鬼刷怪蛋', 'minecraft:villager_spawn_egg': '村民刷怪蛋', 'minecraft:vindicator_spawn_egg': '卫道士刷怪蛋', 'minecraft:vine': '藤蔓', 'minecraft:wandering_trader_spawn_egg': '流浪商人刷怪蛋', 'minecraft:ward_armor_trim_smithing_template': '守卫盔甲纹饰锻造模板', 'minecraft:warden_spawn_egg': '监守者刷怪蛋', 'minecraft:warped_button': '诡异木按钮', 'minecraft:warped_door': '诡异木门', 'minecraft:warped_fence': '诡异木栅栏', 'minecraft:warped_fence_gate': '诡异木栅栏门', 'minecraft:warped_fungus': '诡异菌', 'minecraft:warped_fungus_on_a_stick': '诡异菌钓竿', 'minecraft:warped_hanging_sign': '悬挂式诡异木告示牌', 'minecraft:warped_hyphae': '诡异菌核', 'minecraft:warped_nylium': '诡异菌岩', 'minecraft:warped_planks': '诡异木板', 'minecraft:warped_pressure_plate': '诡异木压力板', 'minecraft:warped_roots': '诡异菌索', 'minecraft:warped_sign': '诡异木告示牌', 'minecraft:warped_slab': '诡异木台阶', 'minecraft:warped_stairs': '诡异木楼梯', 'minecraft:warped_stem': '诡异菌柄', 'minecraft:warped_trapdoor': '诡异木活板门', 'minecraft:warped_wart_block': '诡异疣块', 'minecraft:water_bucket': '水桶', 'minecraft:waxed_copper_block': '涂蜡铜块', 'minecraft:waxed_cut_copper': '涂蜡切制铜块', 'minecraft:waxed_cut_copper_slab': '涂蜡切制铜台阶', 'minecraft:waxed_cut_copper_stairs': '涂蜡切制铜楼梯', 'minecraft:waxed_exposed_copper': '斑驳的涂蜡铜块', 'minecraft:waxed_exposed_cut_copper': '斑驳的涂蜡切制铜块', 'minecraft:waxed_exposed_cut_copper_slab': '斑驳的涂蜡切制铜台阶', 'minecraft:waxed_exposed_cut_copper_stairs': '斑驳的涂蜡切制铜楼梯', 'minecraft:waxed_oxidized_copper': '氧化的涂蜡铜块', 'minecraft:waxed_oxidized_cut_copper': '氧化的涂蜡切制铜块', 'minecraft:waxed_oxidized_cut_copper_slab': '氧化的涂蜡切制铜台阶', 'minecraft:waxed_oxidized_cut_copper_stairs': '氧化的涂蜡切制铜楼梯', 'minecraft:waxed_weathered_copper': '锈蚀的涂蜡铜块', 'minecraft:waxed_weathered_cut_copper': '锈蚀的涂蜡切制铜块', 'minecraft:waxed_weathered_cut_copper_slab': '锈蚀的涂蜡切制铜台阶', 'minecraft:waxed_weathered_cut_copper_stairs': '锈蚀的涂蜡切制铜楼梯', 'minecraft:wayfinder_armor_trim_smithing_template': '向导盔甲纹饰锻造模板', 'minecraft:weathered_copper': '锈蚀的铜块', 'minecraft:weathered_cut_copper': '锈蚀的切制铜块', 'minecraft:weathered_cut_copper_slab': '锈蚀的切制铜台阶', 'minecraft:weathered_cut_copper_stairs': '锈蚀的切制铜楼梯', 'minecraft:weeping_vines': '垂泪藤', 'minecraft:wet_sponge': '湿海绵', 'minecraft:wheat': '小麦', 'minecraft:wheat_seeds': '小麦种子', 'minecraft:white_banner': '白色旗帜', 'minecraft:white_bed': '白色床', 'minecraft:white_candle': '白色蜡烛', 'minecraft:white_carpet': '白色地毯', 'minecraft:white_concrete': '白色混凝土', 'minecraft:white_concrete_powder': '白色混凝土粉末', 'minecraft:white_dye': '白色染料', 'minecraft:white_glazed_terracotta': '白色带釉陶瓦', 'minecraft:white_shulker_box': '白色潜影盒', 'minecraft:white_stained_glass': '白色染色玻璃', 'minecraft:white_stained_glass_pane': '白色染色玻璃板', 'minecraft:white_terracotta': '白色陶瓦', 'minecraft:white_wool': '白色羊毛', 'minecraft:wild_armor_trim_smithing_template': '荒野盔甲纹饰锻造模板', 'minecraft:wind_charge': '风弹', 'minecraft:wither_rose': '凋灵玫瑰', 'minecraft:wither_skeleton_skull': '凋灵骷髅头颅', 'minecraft:wither_skeleton_spawn_egg': '凋灵骷髅刷怪蛋', 'minecraft:wither_spawn_egg': '凋灵刷怪蛋', 'minecraft:wolf_armor': '狼铠', 'minecraft:wolf_spawn_egg': '狼刷怪蛋', 'minecraft:wooden_axe': '木斧', 'minecraft:wooden_hoe': '木锄', 'minecraft:wooden_pickaxe': '木镐', 'minecraft:wooden_shovel': '木锹', 'minecraft:wooden_sword': '木剑', 'minecraft:writable_book': '书与笔', 'minecraft:written_book': '成书', 'minecraft:yellow_banner': '黄色旗帜', 'minecraft:yellow_bed': '黄色床', 'minecraft:yellow_candle': '黄色蜡烛', 'minecraft:yellow_carpet': '黄色地毯', 'minecraft:yellow_concrete': '黄色混凝土', 'minecraft:yellow_concrete_powder': '黄色混凝土粉末', 'minecraft:yellow_dye': '黄色染料', 'minecraft:yellow_glazed_terracotta': '黄色带釉陶瓦', 'minecraft:yellow_shulker_box': '黄色潜影盒', 'minecraft:yellow_stained_glass': '黄色染色玻璃', 'minecraft:yellow_stained_glass_pane': '黄色染色玻璃板', 'minecraft:yellow_terracotta': '黄色陶瓦', 'minecraft:yellow_wool': '黄色羊毛', 'minecraft:zoglin_spawn_egg': '僵尸疣猪兽刷怪蛋', 'minecraft:zombie_head': '僵尸的头', 'minecraft:zombie_horse_spawn_egg': '僵尸马刷怪蛋', 'minecraft:zombie_pigman_spawn_egg': '僵尸猪人刷怪蛋', 'minecraft:zombie_spawn_egg': '僵尸刷怪蛋', 'minecraft:zombie_villager_spawn_egg': '僵尸村民刷怪蛋', 'minecraft:snow_layer': '雪片', 'minecraft:web': '蜘蛛网', 'minecraft:bed': '床', 'minecraft:trapdoor': '活板门', 'minecraft:crafter': '合成器', 'minecraft:note_block': '音符盒', 'minecraft:banner': '旗帜', 'minecraft:portal': '下界传送门方块', 'minecraft:end_portal': '末地传送门方块', 'minecraft:creaking_heart': '嘎枝之心', 'minecraft:oak_button': '橡木按钮', 'minecraft:spruce_button': '云杉木按钮', 'minecraft:birch_button': '白桦木按钮', 'minecraft:jungle_button': '丛林木按钮', 'minecraft:acacia_button': '金合欢木按钮', 'minecraft:dark_oak_button': '深色橡木按钮', 'minecraft:mangrove_button': '红树木按钮', 'minecraft:cherry_button': '樱花木按钮', 'minecraft:pale_oak_button': '苍白橡木按钮', 'minecraft:bamboo_button': '竹按钮', 'minecraft:crimson_button': '绯红木按钮', 'minecraft:warped_button': '诡异木按钮', 'minecraft:oak_leaves': '橡树树叶', 'minecraft:spruce_leaves': '云杉树叶', 'minecraft:birch_leaves': '白桦树叶', 'minecraft:jungle_leaves': '丛林树叶', 'minecraft:acacia_leaves': '金合欢树叶', 'minecraft:dark_oak_leaves': '深色橡树树叶', 'minecraft:azalea_leaves': '杜鹃树叶', 'minecraft:flowering_azalea_leaves': '盛开的杜鹃树叶', 'minecraft:mangrove_leaves': '红树树叶', 'minecraft:cherry_leaves': '樱花树叶', 'minecraft:pale_oak_leaves': '苍白橡树树叶', 'minecraft:sweet_berry_bush': '甜浆果丛', 'minecraft:sweet_berries': '甜浆果', 'minecraft:deadbush': '枯萎的灌木', 'minecraft:rail': '铁轨', 'minecraft:detector_rail': '探测铁轨', 'minecraft:golden_rail': '动力铁轨', 'minecraft:item_frame': '物品展示框', 'minecraft:glow_item_frame': '荧光物品展示框', 'minecraft:slime': '史莱姆', 'minecraft:resin_clump': '树脂团', 'minecraft:netherbrick': '下界砖', 'minecraft:copper_grate': '铜格栅', 'minecraft:exposed_copper_grate': '斑驳的铜格栅', 'minecraft:weathered_copper_grate': '锈蚀的铜格栅', 'minecraft:oxidized_copper_grate': '氧化的铜格栅', 'minecraft:waxed_copper_grate': '涂蜡的铜格栅', 'minecraft:waxed_exposed_copper_grate': '涂蜡的斑驳铜格栅', 'minecraft:waxed_weathered_copper_grate': '涂蜡的锈蚀铜格栅', 'minecraft:waxed_oxidized_copper_grate': '涂蜡的氧化铜格栅', 'minecraft:stonecutter_block': '切石机', 'minecraft:oak_fence_gate': '橡木栅栏门', 'minecraft:spruce_fence_gate': '云杉木栅栏门', 'minecraft:birch_fence_gate': '白桦木栅栏门', 'minecraft:jungle_fence_gate': '丛林木栅栏门', 'minecraft:acacia_fence_gate': '金合欢木栅栏门', 'minecraft:dark_oak_fence_gate': '深色橡木栅栏门', 'minecraft:mangrove_fence_gate': '红树木栅栏门', 'minecraft:cherry_fence_gate': '樱花木栅栏门', 'minecraft:pale_oak_fence_gate': '苍白橡木栅栏门', 'minecraft:bamboo_fence_gate': '竹栅栏门', 'minecraft:crimson_fence_gate': '绯红木栅栏门', 'minecraft:warped_fence_gate': '诡异木栅栏门'}
...
bundles = ['minecraft:bundle', 'minecraft:white_bundle', 'minecraft:light_gray_bundle', 'minecraft:gray_bundle', 'minecraft:black_bundle', 'minecraft:brown_bundle', 'minecraft:red_bundle', 'minecraft:orange_bundle', 'minecraft:yellow_bundle', 'minecraft:lime_bundle', 'minecraft:green_bundle', 'minecraft:cyan_bundle', 'minecraft:light_blue_bundle', 'minecraft:blue_bundle', 'minecraft:purple_bundle', 'minecraft:magenta_bundle', 'minecraft:pink_bundle']
block_name_to_item_name = {'minecraft:standing_sign': 'minecraft:oak_sign', 'minecraft:spruce_standing_sign': 'minecraft:spruce_sign', 'minecraft:birch_standing_sign': 'minecraft:birch_sign', 'minecraft:jungle_standing_sign': 'minecraft:jungle_sign', 'minecraft:acacia_standing_sign': 'minecraft:acacia_sign', 'minecraft:darkoak_standing_sign': 'minecraft:dark_oak_sign', 'minecraft:mangrove_standing_sign': 'minecraft:mangrove_sign', 'minecraft:cherry_standing_sign': 'minecraft:cherry_sign', 'minecraft:pale_oak_standing_sign': 'minecraft:pale_oak_sign', 'minecraft:bamboo_standing_sign': 'minecraft:bamboo_sign', 'minecraft:crimson_standing_sign': 'minecraft:crimson_sign', 'minecraft:warped_standing_sign': 'minecraft:warped_sign', 'minecraft:wall_sign': 'minecraft:oak_sign', 'minecraft:spruce_wall_sign': 'minecraft:spruce_sign', 'minecraft:birch_wall_sign': 'minecraft:birch_sign', 'minecraft:jungle_wall_sign': 'minecraft:jungle_sign', 'minecraft:acacia_wall_sign': 'minecraft:acacia_sign', 'minecraft:darkoak_wall_sign': 'minecraft:dark_oak_sign', 'minecraft:mangrove_wall_sign': 'minecraft:mangrove_sign', 'minecraft:cherry_wall_sign': 'minecraft:cherry_sign', 'minecraft:pale_oak_wall_sign': 'minecraft:pale_oak_sign', 'minecraft:bamboo_wall_sign': 'minecraft:bamboo_sign', 'minecraft:crimson_wall_sign': 'minecraft:crimson_sign', 'minecraft:warped_wall_sign': 'minecraft:warped_sign', 'minecraft:powered_repeater': 'minecraft:repeater', 'minecraft:powered_comparator': 'minecraft:comparator', 'minecraft:unpowered_repeater': 'minecraft:repeater', 'minecraft:unpowered_comparator': 'minecraft:comparator', 'minecraft:unlit_redstone_torch': 'minecraft:redstone_torch', 'minecraft:lit_redstone_lamp': 'minecraft:redstone_lamp', 'minecraft:redstone_wire': 'minecraft:redstone', 'minecraft:daylight_detector_inverted': 'minecraft:daylight_detector', 'minecraft:trip_wire': 'minecraft:string', 'minecraft:fire': 'minecraft:fire_charge', 'minecraft:soul_fire': 'minecraft:fire_charge', 'minecraft:powder_snow': 'minecraft:powder_snow_bucket', 'minecraft:lava': 'minecraft:lava_bucket', 'minecraft:water': 'minecraft:water_bucket', 'minecraft:smooth_stone_double_slab': 'minecraft:smooth_stone_slab', 'minecraft:normal_stone_double_slab': 'minecraft:stone_slab', 'minecraft:cobblestone_double_slab': 'minecraft:cobblestone_slab', 'minecraft:mossy_cobblestone_double_slab': 'minecraft:mossy_cobblestone_slab', 'minecraft:oak_double_slab': 'minecraft:oak_slab', 'minecraft:spruce_double_slab': 'minecraft:spruce_slab', 'minecraft:birch_double_slab': 'minecraft:birch_slab', 'minecraft:jungle_double_slab': 'minecraft:jungle_slab', 'minecraft:acacia_double_slab': 'minecraft:acacia_slab', 'minecraft:dark_oak_double_slab': 'minecraft:dark_oak_slab', 'minecraft:mangrove_double_slab': 'minecraft:mangrove_slab', 'minecraft:cherry_double_slab': 'minecraft:cherry_slab', 'minecraft:pale_oak_double_slab': 'minecraft:pale_oak_slab', 'minecraft:bamboo_double_slab': 'minecraft:bamboo_slab', 'minecraft:bamboo_mosaic_double_slab': 'minecraft:bamboo_mosaic_slab', 'minecraft:stone_brick_double_slab': 'minecraft:stone_brick_slab', 'minecraft:mossy_stone_brick_double_slab': 'minecraft:mossy_stone_brick_slab', 'minecraft:sandstone_double_slab': 'minecraft:sandstone_slab', 'minecraft:cut_sandstone_double_slab': 'minecraft:cut_sandstone_slab', 'minecraft:smooth_sandstone_double_slab': 'minecraft:smooth_sandstone_slab', 'minecraft:red_sandstone_double_slab': 'minecraft:red_sandstone_slab', 'minecraft:cut_red_sandstone_double_slab': 'minecraft:cut_red_sandstone_slab', 'minecraft:smooth_red_sandstone_double_slab': 'minecraft:smooth_red_sandstone_slab', 'minecraft:granite_double_slab': 'minecraft:granite_slab', 'minecraft:polished_granite_double_slab': 'minecraft:polished_granite_slab', 'minecraft:diorite_double_slab': 'minecraft:diorite_slab', 'minecraft:polished_diorite_double_slab': 'minecraft:polished_diorite_slab', 'minecraft:andesite_double_slab': 'minecraft:andesite_slab', 'minecraft:polished_andesite_double_slab': 'minecraft:polished_andesite_slab', 'minecraft:brick_double_slab': 'minecraft:brick_slab', 'minecraft:nether_brick_double_slab': 'minecraft:nether_brick_slab', 'minecraft:red_nether_brick_double_slab': 'minecraft:red_nether_brick_slab', 'minecraft:end_stone_brick_double_slab': 'minecraft:end_stone_brick_slab', 'minecraft:quartz_double_slab': 'minecraft:quartz_slab', 'minecraft:smooth_quartz_double_slab': 'minecraft:smooth_quartz_slab', 'minecraft:purpur_double_slab': 'minecraft:purpur_slab', 'minecraft:prismarine_double_slab': 'minecraft:prismarine_slab', 'minecraft:dark_prismarine_double_slab': 'minecraft:dark_prismarine_slab', 'minecraft:prismarine_brick_double_slab': 'minecraft:prismarine_brick_slab', 'minecraft:crimson_double_slab': 'minecraft:crimson_slab', 'minecraft:warped_double_slab': 'minecraft:warped_slab', 'minecraft:blackstone_double_slab': 'minecraft:blackstone_slab', 'minecraft:polished_blackstone_double_slab': 'minecraft:polished_blackstone_slab', 'minecraft:polished_blackstone_brick_double_slab': 'minecraft:polished_blackstone_brick_slab', 'minecraft:cobbled_deepslate_double_slab': 'minecraft:cobbled_deepslate_slab', 'minecraft:polished_deepslate_double_slab': 'minecraft:polished_deepslate_slab', 'minecraft:deepslate_tile_double_slab': 'minecraft:deepslate_tile_slab', 'minecraft:deepslate_brick_double_slab': 'minecraft:deepslate_brick_slab', 'minecraft:tuff_double_slab': 'minecraft:tuff_slab', 'minecraft:polished_tuff_double_slab': 'minecraft:polished_tuff_slab', 'minecraft:tuff_brick_double_slab': 'minecraft:tuff_brick_slab', 'minecraft:mud_brick_double_slab': 'minecraft:mud_brick_slab', 'minecraft:cut_copper_double_slab': 'minecraft:cut_copper_slab', 'minecraft:exposed_cut_copper_double_slab': 'minecraft:exposed_cut_copper_slab', 'minecraft:weathered_cut_copper_double_slab': 'minecraft:weathered_cut_copper_slab', 'minecraft:oxidized_cut_copper_double_slab': 'minecraft:oxidized_cut_copper_slab', 'minecraft:waxed_cut_copper_double_slab': 'minecraft:waxed_cut_copper_slab', 'minecraft:waxed_exposed_cut_copper_double_slab': 'minecraft:waxed_exposed_cut_copper_slab', 'minecraft:waxed_weathered_cut_copper_double_slab': 'minecraft:waxed_weathered_cut_copper_slab', 'minecraft:waxed_oxidized_cut_copper_double_slab': 'minecraft:waxed_oxidized_cut_copper_slab', 'minecraft:resin_brick_double_slab': 'minecraft:resin_brick_slab', 'minecraft:lit_furnace': 'minecraft:furnace', 'minecraft:lit_blast_furnace': 'minecraft:blast_furnace', 'minecraft:lit_smoker': 'minecraft:smoker', 'minecraft:redstone_wire': 'minecraft:redstone', 'minecraft:wall_torch': 'minecraft:torch', 'minecraft:redstone_wall_torch': 'minecraft:redstone_torch', 'minecraft:soul_wall_torch': 'minecraft:soul_torch', 'minecraft:wall_sign': 'minecraft:sign', 'minecraft:lit_redstone_ore': 'minecraft:redstone_ore', 'minecraft:deepslate_lit_redstone_ore': 'minecraft:deepslate_redstone_ore', 'minecraft:wheat': 'minecraft:wheat_seeds', 'minecraft:carrots': 'minecraft:carrot', 'minecraft:potatoes': 'minecraft:potato', 'minecraft:beetroot': 'minecraft:beetroot_seeds', 'minecraft:standing_banner': 'minecraft:banner', 'minecraft:wall_banner': 'minecraft:banner'}
block_name_to_set_name = {'minecraft:lit_redstone_lamp': 'minecraft:redstone_lamp', 'minecraft:powered_repeater': 'minecraft:unpowered_repeater', 'minecraft:powered_comparator': 'minecraft:unpowered_comparator', 'minecraft:lit_furnace': 'minecraft:furnace', 'minecraft:lit_blast_furnace': 'minecraft:blast_furnace', 'minecraft:lit_smoker': 'minecraft:smoker', 'minecraft:lit_redstone_ore': 'minecraft:redstone_ore', 'minecraft:deepslate_lit_redstone_ore': 'minecraft:deepslate_redstone_ore'}
black_block_name = {'minecraft:undyed_shulker_box', 'minecraft:orange_shulker_box', 'minecraft:white_shulker_box', 'minecraft:magenta_shulker_box', 'minecraft:light_blue_shulker_box', 'minecraft:yellow_shulker_box', 'minecraft:lime_shulker_box', 'minecraft:pink_shulker_box', 'minecraft:gray_shulker_box', 'minecraft:light_gray_shulker_box', 'minecraft:cyan_shulker_box', 'minecraft:purple_shulker_box', 'minecraft:blue_shulker_box', 'minecraft:brown_shulker_box', 'minecraft:green_shulker_box', 'minecraft:red_shulker_box', 'minecraft:black_shulker_box', 'minecraft:piston_arm_collision', 'minrcraft:sticky_piston_arm_collision', 'minecraft:water', 'minecraft:bubble_column'}
black_item_name = {'minecraft:undyed_shulker_box', 'minecraft:orange_shulker_box', 'minecraft:white_shulker_box', 'minecraft:magenta_shulker_box', 'minecraft:light_blue_shulker_box', 'minecraft:yellow_shulker_box', 'minecraft:lime_shulker_box', 'minecraft:pink_shulker_box', 'minecraft:gray_shulker_box', 'minecraft:light_gray_shulker_box', 'minecraft:cyan_shulker_box', 'minecraft:purple_shulker_box', 'minecraft:blue_shulker_box', 'minecraft:brown_shulker_box', 'minecraft:green_shulker_box', 'minecraft:red_shulker_box', 'minecraft:black_shulker_box', 'minecraft:bundle', 'minecraft:white_bundle', 'minecraft:light_gray_bundle', 'minecraft:gray_bundle', 'minecraft:black_bundle', 'minecraft:brown_bundle', 'minecraft:red_bundle', 'minecraft:orange_bundle', 'minecraft:yellow_bundle', 'minecraft:lime_bundle', 'minecraft:green_bundle', 'minecraft:cyan_bundle', 'minecraft:light_blue_bundle', 'minecraft:blue_bundle', 'minecraft:purple_bundle', 'minecraft:magenta_bundle', 'minecraft:pink_bundle'}
...
class TAG_Int_Array(BaseTag):
    ...
    def pretty(self, indent=0, indent_str='  '):
        return '{0}TAG_Int_Array({1!r}): [{2} integers]'.format(indent_str * indent, self.name, len(self.value))
...
class StructureBlock:
    ...
    def __init__(self, namespace, base_name, states={}, extra_data={}, compability_version=COMPABILITY_VERSION):
...
class Structure:
    ...
    def get_block_no_check(self, coordinate):
        index = coordinate[0] * self.yz + coordinate[1] * self.z + coordinate[2]
        block = self._palette[self.structure_indecis[index]]
        if index in self._special_blocks:
            block.extra_data.update(self._special_blocks[index])
...
class Item:
    ...
    def get_identifier(self, include_count=False):
    ...
    @staticmethod
    def get_llse_item_identifier(llse_item, include_count=False):
...
class Container:
    ...
    def remove_item(self, target_item, check=True):
        ...
        for search_item in self.items:
            if target_item.match(search_item):
                ...
                if count >= search_item_count:
                    ...
                    nbt.setTag('Count', NbtByte(search_item_count - count))
                ...
                for i in range(items_tag.getSize()):
                    ...
                    if isinstance(item_nbt, NbtCompound):
                        if target_item.match(item_nbt):
                            search_item: LLSE_Item = mc.newItem(item_nbt)
                            search_item_count = search_item.count
                            if count >= search_item_count:
                                search_item.setNull()
                                count -= search_item_count
    ...
    def check_enougn_item(self, target_item, count=None):
    ...
    def get_match_item(self, target_item, check_count=True, copy_and_set_count=True):
        if self.current_player_mode == PlayerGameMode.creative:
    ...
    def get_all_container_item(self):
...
def run_set_cmd(block_name, pos, states):
...
class Block:
    ...
    def base_item(self):
        ...
        return Item(block_name_to_item_name.get(block_identifier, block_identifier), 1)
    ...
    def process_state(self, pos, *args):
    ...
    def material_need(self, world_block):
    ...
    @staticmethod
    def get_base_item(structure_block):
        ...
        if block_entity_data and mc_block.hasBlockEntity():
            ...
            def clean_empty(obj):
                if isinstance(obj, dict):
                    return {k: v if not Item.is_item(v) else Item(v).get_identifier(include_count=True) for k, v in ((k, clean_empty(v)) for k, v in obj.items()) if v}
                if isinstance(obj, list):
                    return [clean_empty(v) if not Item.is_item(v) else Item(v).get_identifier(include_count=True) for v in obj if clean_empty(v)]
                return obj
...
class Door(Block):
    ...
    def set_block(self, pos, pc, structure, rel_pos):
...
class Bed(Block):
    direction_offsets = {0: (0, 0, -1), 1: (1, 0, 0), 2: (0, 0, 1), 3: (-1, 0, 0)}
...
class Candle(Block):
    ...
    def base_item(self):
        block_identifier = self.block.identifier
        item_name = block_name_to_item_name.get(block_identifier, block_identifier)
        return Item(item_name, self.block.states['candles'] + 1)
...
class Vein(Block):
    ...
    def base_item(self):
        ...
        count = 0
        for face in (1, 2, 4, 8, 16, 32):
            if direction_bits & face:
                count += 1
        item_name = block_name_to_item_name.get(block_identifier, block_identifier)
        return Item(item_name, count)
...
class Pink_petals(Block):
    ...
    def base_item(self):
        block_identifier = self.block.identifier
        item_name = block_name_to_item_name.get(block_identifier, block_identifier)
        return Item(item_name, self.block.states['growth'] + 1)
...
class Sea_pickle(Block):
    ...
    def base_item(self):
        block_identifier = self.block.identifier
        item_name = block_name_to_item_name.get(block_identifier, block_identifier)
        return Item(item_name, self.block.states['cluster_count'] + 1)
...
def setblock(pc, player, pos, structure_block, structure, rel_pos):
    try:
...
def Blockinit():
    Double_slab.init(['minecraft:oak_double_slab', 'minecraft:spruce_double_slab', 'minecraft:birch_double_slab', 'minecraft:jungle_double_slab', 'minecraft:acacia_double_slab', 'minecraft:dark_oak_double_slab', 'minecraft:mangrove_double_slab', 'minecraft:cherry_double_slab', 'minecraft:pale_oak_double_slab', 'minecraft:bamboo_double_slab', 'minecraft:crimson_double_slab', 'minecraft:warped_double_slab'])
    Candle.init(['minecraft:candle', 'minecraft:white_candle', 'minecraft:orange_candle', 'minecraft:magenta_candle', 'minecraft:light_blue_candle', 'minecraft:yellow_candle', 'minecraft:lime_candle', 'minecraft:pink_candle', 'minecraft:gray_candle', 'minecraft:light_gray_candle', 'minecraft:cyan_candle', 'minecraft:purple_candle', 'minecraft:blue_candle', 'minecraft:brown_candle', 'minecraft:green_candle', 'minecraft:red_candle', 'minecraft:black_candle'])
    Vein.init(['minecraft:sculk_vein', 'minecraft:resin_clump', 'minecraft:glow_lichen', 'minecraft:vine'])
...
class Structure_Setting:
        ...
        for y in range(y_start, y_end):
            ...
            for x in range(size_x):
                ...
                for z in range(size_z):
                    ...
                    if structure.get_block_no_check(coord).identifier in black_block_name:
                        continue
    ...
    def get_current_lalyer_all_materials(self):
...
class PlayerSettings:
    ...
    def add_structure(self, structure_setting):
    ...
    def remove_structure(self, structure_setting):
        if structure_setting.name in self.structues_dict:
            self.structures.remove(self.structues_dict[structure_setting.name])
            self.structues_dict.pop(structure_setting.name)

    @classmethod
    def player_left(cls, player):
        cls.players.pop(player.uuid, None)

class Ui:

    @staticmethod
    def show_main_form(cmd, origin, output, results):
    ...
    @staticmethod
    def from_main_callable(player, id, reason):
        if id is None:
            return
        if id == 0:
    ...
    def show_add_form(player):
        ...
        player_setting.attached_data = {'available_structures': available_structures, 'player_pos': (player_pos.x, player_pos.y, player_pos.z, player_pos.dimid)}
        player.sendForm(fm, Ui.from_add_structure_callable)

    @staticmethod
    def show_share_structure_form(player):
        uuid = player.uuid
        if uuid not in PlayerSettings.players:
            PlayerSettings.players[uuid] = PlayerSettings(uuid)
        player_setting = PlayerSettings.players[uuid]
        ...
        player_setting.attached_data = {'online_players': [p.uuid for p in online_players]}
        player.sendForm(fm, Ui.from_share_structure_callable)

    @staticmethod
    def show_remove_form(player):
        uuid = player.uuid
        if uuid not in PlayerSettings.players:
            PlayerSettings.players[uuid] = PlayerSettings(uuid)
        player_setting = PlayerSettings.players[uuid]
    ...
    @staticmethod
    def from_modify_select_callable(player, id, reason):
        if id is None:
            return
        uuid = player.uuid
        if uuid not in PlayerSettings.players:
        ...
        player_setting.attached_data = {'current_structure': structure_setting}
        player.sendForm(fm, Ui.from_modify_operation_callable)

    @staticmethod
    def from_add_structure_callable(player, data, reason):
        if data is None:
            return
        uuid = player.uuid
        if uuid not in PlayerSettings.players:
        ...
        structure_setting = Structure_Setting(name=structure_name, pos=tuple((i + j for i, j in zip(temp_data['player_pos'], (offset_x, offset_y, offset_z, 0)))), prevent_mismatch_level=prevent_level, current_layer=1)
    ...
    @staticmethod
    def from_share_structure_callable(player, data, reason):
        if data is None:
            return
        uuid = player.uuid
        if uuid not in PlayerSettings.players:
    ...
    @staticmethod
    def from_remove_structure_callable(player, data, reason):
        if data is None:
            return
        uuid = player.uuid
        if uuid not in PlayerSettings.players:
        ...
        original_count = len(data) - 1
        new_count = len(player_setting.structures)
    ...
    @staticmethod
    def from_modify_operation_callable(player, id, reason):
        if id is None:
            return
        uuid = player.uuid
        if uuid not in PlayerSettings.players:
    ...
    @staticmethod
    def show_detail_settings_form(player, structure_setting):
        if data is None:
            return
    ...
    @staticmethod
    def from_add_modify_structure(player, data, reason):
        if data is None:
            return
        uuid = player.uuid
        if uuid not in PlayerSettings.players:
        ...
        structure_setting = Structure_Setting(name=structure_name, pos=pos, prevent_mismatch_level=prevent_level, current_layer=current_layer)
        player_setting.add_structure(structure_setting)
        player.sendText(f'成功修改结构设置: {structure_name}')

    @staticmethod
    def empty_callable(*args):
        return

    @staticmethod
    def format_materials_for_display(materials, static_item_stack_num={}):
        if not materials:
            return '无材料需求'
        lines = []
...
class TickEvent:
    ...
    @classmethod
    def place_along_view(cls, player, start_pos, direction, player_setting):
        max_distance = 5.5
        ...
        for i in range(1000):
            ...
            if vec_x * dir_x + vec_y * dir_y + vec_z * dir_z < 0:
                break
            if dir_x > 0:
                x_dis = (floor(x + (1 + 1e-06)) - x) / dir_x if dir_x != 0 else float('inf')
            elif dir_x < 0:
                x_dis = (ceil(x - (1 + 1e-06)) - x) / dir_x if dir_x != 0 else float('inf')
            else:
                x_dis = float('inf')
            if dir_y > 0:
                y_dis = (floor(y + (1 + 1e-06)) - y) / dir_y if dir_y != 0 else float('inf')
            elif dir_y < 0:
                y_dis = (ceil(y - (1 + 1e-06)) - y) / dir_y if dir_y != 0 else float('inf')
            else:
                y_dis = float('inf')
            if dir_z > 0:
                z_dis = (floor(z + (1 + 1e-06)) - z) / dir_y if dir_z != 0 else float('inf')
            elif dir_z < 0:
                z_dis = (ceil(z - (1 + 1e-06)) - z) / dir_y if dir_z != 0 else float('inf')
            else:
                z_dis = float('inf')
    ...
    @classmethod
    def place_circle_around_player(cls, player, start_pos, direction, player_setting):
    ...
    @staticmethod
    def set_block_player_setting(pc, player, player_setting, pos):
        for structure_setting in player_setting.structures:
            ...
            if structure_block is not None and structure_block.identifier not in black_block_name and (structure_block.identifier != 'minecraft:air'):
                ...
                if world_block is None or world_block.type != 'minecraft:air':
                    return False
                if setblock(pc, player, pos, structure_block, structure_setting.structure, structure_setting.get_rel_pos(pos)):
                    player.refreshItems()
                    return True
        return False

def set_block(player, pos):
    """第一个是拦截玩家， 第2个是放置成功"""
    uuid = player.uuid
    if uuid not in PlayerSettings.players:
        return (False, False)
    ...
    for structure_setting in player_setting.structures:
        ...
        if structure_block.identifier not in black_block_name and structure_block.identifier != 'minecraft:air':
            ...
            if world_block is None or world_block.type != 'minecraft:air':
                return (False, False)
            pc = Container(player.getInventory())
            func_res = setblock(pc, player, pos, structure_block, structure_setting.structure, structure_setting.get_rel_pos(pos))
            Container.current_player_mode = None
            Container.current_player = None
            if func_res:
                player.refreshItems()
...
def auto_place(player, block, face):
    try:
